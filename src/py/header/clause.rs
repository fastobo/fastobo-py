...
impl SubsetdefClause {
    ...
    impl_raw_value!("{} {}", self.subset, self.description);
}
...
impl TreatXrefsAsGenusDifferentiaClause {
    ...
    impl_raw_value!("{} {} {}", self.idspace, self.relation, self.filler);
}
...
impl TreatXrefsAsRelationshipClause {
    ...
    impl_raw_value!("{} {}", self.idspace, self.relation);
}
